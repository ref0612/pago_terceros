...
var TRANSLATIONS = {
  es: {
    ...
    // Empresario portal
    ev_portal_sub:       'Portal de Empresarios',
    ev_label_from:       'DESDE',
    ev_label_to:         'HASTA',
    ev_btn_load:         'Cargar',
    ev_btn_pdf:          '⬇ PDF',
    ev_btn_signout:      '⎋ Cerrar sesión',
    ev_loading:          'Cargando tu información…',
    ev_gross:            'PRODUCCIÓN BRUTA',
    ev_commission:       'COMISIÓN',
    ev_fuel:             'COMBUSTIBLE (ARAMCO)',
    ev_total:            'TOTAL A RECIBIR',
    ev_services:         'SERVICIOS',
    ev_status_title:     'Estado de Pago por Día',
    ev_metrics_title:    'Métricas del Período',
    ev_metric_bus:       'Bus más utilizado',
    ev_metric_route:     'Ruta más productiva',
    ev_metric_seats:     'Promedio asientos / servicio',
    ev_chart_title:      'Ingreso Neto Diario',
    ev_no_services:      'Sin servicios en el período seleccionado.',
    ev_th_time:          'Hora',
    ev_th_route:         'Ruta',
    ev_th_service:       'Servicio',
    ev_th_bus:           'Bus · Patente',
    ev_th_status:        'Estado',
    ev_th_seats:         'Asientos',
    ev_th_production:    'Producción',
    ev_th_commission:    'Comisión',
    ev_th_net:           'Total Neto',
    ev_th_totals:        'TOTALES',
    ev_lbl_prod:         'Prod.',
    ev_lbl_net:          'Neto',
    ev_lbl_svc:          'Svc',
    ev_vs_prev:          'vs ant.',
    ev_ref:              'Ref:',
    ev_approved_by:      '✓ Aprobado por',
    ev_status_pending:   'Pendiente',
    ev_status_approved:  'Aprobado',
    ev_status_rejected:  'Rechazado',
    ev_status_paid:      'Pagado',
    // Operator panel (supervisor)
    op_panel_title:      'Cuentas de Empresarios',
    op_form_title:       'Agregar cuenta',
    op_ph_user:          'usuario',
    op_ph_pass:          'contraseña',
    op_ph_code:          'ENT-XXXXX',
    op_ph_name:          'Nombre completo',
    op_btn_create:       'Crear cuenta',
    op_btn_remove:       'Eliminar',
    op_remove_title:     'Eliminar acceso de empresario',
    op_remove_detail:    'Eliminar acceso de login para',
    op_remove_note:      'Ya no podrá iniciar sesión.',
    op_remove_ok:        'Eliminar',
    op_toast_removed:    'eliminado',
    op_toast_created:    'creado',
    op_err_required:     'Usuario, contraseña y código ENT son requeridos.',
    op_err_format:       'El código ENT debe tener el formato ENT-XXXXX',
    op_loading:          'Cargando…',
    op_empty:            'No hay cuentas de empresarios aún.',
  ...
  en: {
    ...
    // Empresario portal
    ev_portal_sub:       'Operator Portal',
    ev_label_from:       'FROM',
    ev_label_to:         'TO',
    ev_btn_load:         'Load',
    ev_btn_pdf:          '⬇ PDF',
    ev_btn_signout:      '⎋ Sign out',
    ev_loading:          'Loading your data…',
    ev_gross:            'GROSS PRODUCTION',
    ev_commission:       'COMMISSION',
    ev_fuel:             'FUEL (ARAMCO)',
    ev_total:            'TOTAL TO RECEIVE',
    ev_services:         'SERVICES',
    ev_status_title:     'Payment Status by Day',
    ev_metrics_title:    'Period Metrics',
    ev_metric_bus:       'Most used bus',
    ev_metric_route:     'Most productive route',
    ev_metric_seats:     'Avg seats sold / service',
    ev_chart_title:      'Daily Net Revenue',
    ev_no_services:      'No services found for this period.',
    ev_th_time:          'Time',
    ev_th_route:         'Route',
    ev_th_service:       'Service',
    ev_th_bus:           'Bus · Plate',
    ev_th_status:        'Status',
    ev_th_seats:         'Seats',
    ev_th_production:    'Production',
    ev_th_commission:    'Commission',
    ev_th_net:           'Net Total',
    ev_th_totals:        'TOTALS',
    ev_lbl_prod:         'Prod.',
    ev_lbl_net:          'Net',
    ...
    ev_vs_prev:          'vs prev',
    ev_ref:              'Ref:',
    ev_approved_by:      '✓ Approved by',
    ev_status_pending:   'Pending',
    ev_status_approved:  'Approved',
    ev_status_rejected:  'Rejected',
    ev_status_paid:      'Paid',
    // Operator panel (supervisor)
    op_panel_title:      'Operator Accounts',
    op_form_title:       'Add operator account',
    op_ph_user:          'username',
    op_ph_pass:          'password',
    op_ph_code:          'ENT-XXXXX',
    op_ph_name:          'Full name',
    op_btn_create:       'Create account',
    op_btn_remove:       'Remove',
    op_remove_title:     'Remove operator access',
    op_remove_detail:    'Remove login access for',
    op_remove_note:      'They will no longer be able to sign in.',
    op_remove_ok:        'Remove',
    op_toast_removed:    'removed',
    op_toast_created:    'created',
    op_err_required:     'Username, password and ENT code are required.',
    op_err_format:       'ENT code must match format ENT-XXXXX',
    op_loading:          'Loading…',
    op_empty:            'No operator accounts yet.',
